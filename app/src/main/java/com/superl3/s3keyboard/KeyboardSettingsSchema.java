...
final class KeyboardSettingsSchema {
    ...
    private static List<Entry> buildEntries() {
        ...
        add(entries, Section.INPUT_FEEL,
                ...
                KeyboardPreferences.TRANSPARENT_OVERLAY_INPUT_ENABLED,
                KeyboardPreferences.TRANSPARENT_OVERLAY_STYLE,
                KeyboardPreferences.WATCH_RADIAL_INPUT_ENABLED,
                ...
                KeyboardPreferences.ENGLISH_SUGGESTIONS_ENABLED,
